...
class PDFToMarkdownConverter:
    ...
    def convert_pdf(self, pdf_path: str, output_dir: str) -> str:
        """
        Convert a single PDF document to Markdown.

        Args:
            pdf_path: Source PDF path.
            output_dir: Directory to write the generated markdown file to.
    ...
    def convert_directory(self, input_dir: str, output_dir: str) -> list[str]:
        ...
        Args:
            ...
            output_dir: Directory to write generated markdown files to.
